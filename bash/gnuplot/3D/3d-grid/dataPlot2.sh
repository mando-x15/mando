...
#blue
set style line 5 lc rgb '#C6DBEF' lt 3 lw 0.25 pt 3 pi -1 ps 1.0 
set style line 6 lc rgb '#6BAED6' lt 3 lw 0.25 pt 3 pi -1 ps 1.0 
set style line 7 lc rgb '#3182BD' lt 3 lw 0.25 pt 9 pi -1 ps 1.0 
set style line 8 lc rgb '#08519C' lt 3 lw 0.15 pt 7 pi -1 ps 1.0 
...
set style line 21 lc rgb '#4F974F' lt 3 lw 0.25 pt 11 pi -1 ps 1.0 # --- purple
...
set style line 24 lc rgb '#000000' lt 3 lw 0.25 pt 3 pi -1 ps 1.0 #gray dotted
...
set key top right
set title "Dr data"
splot "data.txt" using 1:2:3 every ::1::28 with linespoints ls 4 pt 7 title '1e-3' ,\
"data.txt" using 1:2:3 every ::29::57 with linespoints ls 3 title '1e-4' ,\
"data.txt" using 1:2:3 every ::58::85 with linespoints ls 2 title '1e-5' ,\
"data.txt" using 1:2:3 every ::86::113 with linespoints ls 1 title '1e-6' ,\
"data.txt" using 1:2:3 every ::113::140 with linespoints ls 18 notitle ,\
"data.txt" using 1:2:3 every ::141::169 with linespoints ls 4 pt 7 notitle,\
"data.txt" using 1:2:3 every ::170::197 with linespoints ls 3 notitle ,\
"data.txt" using 1:2:3 every ::198::226 with linespoints ls 2 notitle ,\
"data.txt" using 1:2:3 every ::227::255 with linespoints ls 1 notitle ,\
"data.txt" using 1:2:3 every ::256::283 with linespoints ls 4 notitle ,\
"data.txt" using 1:2:3 every ::284::311 with linespoints ls 3 notitle ,\
"data.txt" using 1:2:3 every ::312::339 with linespoints ls 2 notitle ,\
"data.txt" using 1:2:3 every ::340::367 with linespoints ls 1 notitle ,\
"data.txt" using 1:2:3 every ::368::396 with linespoints ls 4 notitle,\
"data.txt" using 1:2:3 every ::397::424 with linespoints ls 3 notitle ,\
"data.txt" using 1:2:3 every ::425::452 with linespoints ls 2 notitle ,\
"data.txt" using 1:2:3 every ::453::476 with linespoints ls 1 notitle 
